...
var mergeTrees = function (t1, t2) {
    let mergeTreesRec = (node1, node2) => {
        ...
        node.left = mergeTreesRec(node1 ? node1.left : null, node2 ? node2.left : null);
        node.right = mergeTreesRec(node1 ? node1.right : null, node2 ? node2.right : null);
        return node;
    }
